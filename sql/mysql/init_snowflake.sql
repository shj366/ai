...
(2147098509659213826, '供应商管理', 'AIProviderManage', '/plugins/ai/provider', 2, 'mdi:hub-outline', 1, '/plugins/ai/views/provider/index', null, 1, 1, 1, '', null, 2147098509659213824, now(), null),
...
(2147098509659213830, '模型管理', 'AIModelManage', '/plugins/ai/model', 3, 'carbon:model-alt', 1, '/plugins/ai/views/model/index', null, 1, 1, 1, '', null, 2147098509659213824, now(), null),
